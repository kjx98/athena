...
namespace eosio {
namespace vm {
DECLARE_EXCEPTION(wasm_interpreter_exception, 4000000,
                  "wasm interpreter exception")
DECLARE_EXCEPTION(wasm_section_length_exception, 4000001,
...
DECLARE_EXCEPTION(wasm_vector_oob_exception, 4000004,
                  "wasm vector out of bounds")
DECLARE_EXCEPTION(wasm_unsupported_import_exception, 4000005,
