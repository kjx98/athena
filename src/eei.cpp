...
void WasmEngine::collectBenchmarkingData()
{
  ...
  void EthereumInterface::debugPrintStorage(bool useHex, uint32_t pathOffset)
  {
      ...
      H_DEBUG << depthToString() << " DEBUG printStorage" << (useHex ? "Hex" : "") << "(0x" << hex;
  ...
  void EthereumInterface::debugEvmTrace(uint32_t pc, int32_t opcode, uint32_t cost, int32_t sp)
  {
      ...
      athenaAssert(sp <= (1024 * stackItemSize), "EVM stack pointer out of bounds.");
  ...
  {
      H_DEBUG << depthToString() << " getExternalBalance " << hex << addressOffset << " " << resultOffset << dec << "\n";
  ...
  {
      H_DEBUG << depthToString() << " getBlockHash " << hex << number << " " << resultOffset << dec << "\n";
  ...
  {
#if H_DEBUGGING
      H_DEBUG << depthToString() << " callDataCopy " << hex << resultOffset << " " << dataOffset << " " << length << dec << "\n";
#endif
  ...
  {
      H_DEBUG << depthToString() << " codeCopy " << hex << resultOffset << " " << codeOffset << " " << length << dec << "\n";
  ...
  {
      H_DEBUG << depthToString() << " externalCodeCopy " << hex << addressOffset << " " << resultOffset << " " << codeOffset << " " << length << dec << "\n";
  ...
  {
      H_DEBUG << depthToString() << " getExternalCodeSize " << hex << addressOffset << dec << "\n";
  ...
  {
      H_DEBUG << depthToString() << " getBlockCoinbase " << hex << resultOffset << dec << "\n";
  ...
  {
      H_DEBUG << depthToString() << " log " << hex << dataOffset << " " << length << " " << numberOfTopics << dec << "\n";
  ...
  {
      H_DEBUG << depthToString() << " storageStore " << hex << pathOffset << " " << valueOffset << dec << "\n";
  ...
  {
      H_DEBUG << depthToString() << " storageLoad " << hex << pathOffset << " " << resultOffset << dec << "\n";
  ...
  {
#if H_DEBUGGING
      H_DEBUG << depthToString() << " " << (revert ? "revert " : "finish ") << hex << offset << " " << size << dec << "\n";
#endif
  ...
  {
      H_DEBUG << depthToString() << " returnDataCopy " << hex << dataOffset << " " << offset << " " << size << dec << "\n";
  ...
  {
      H_DEBUG << depthToString() << " create " << hex << valueOffset << " " << dataOffset << " " << length << dec << " " << resultOffset << dec << "\n";
  ...
  void EthereumInterface::loadMemoryReverse(uint32_t srcOffset, uint8_t *dst, size_t length)
  {
    ...
    if (!length)
      H_DEBUG << "Zero-length memory load from offset 0x" << hex << srcOffset << dec << "\n";
  ...
  void EthereumInterface::storeMemoryReverse(const uint8_t *src, uint32_t dstOffset, uint32_t length)
  {
    ...
    if (!length)
      H_DEBUG << "Zero-length memory store to offset 0x" << hex << dstOffset << dec << "\n";
